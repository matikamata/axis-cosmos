...
- Version: 0.1.1
- Run ID: 2026-05-20T07:58:33.923864+00:00
...
Checks passed:
- Root path is the expected axis-cosmos-lab
...
- CONTEXT: provenance marker not found as exact wording, review formatting before relying on automation: source path
- CONTEXT: provenance marker not found as exact wording, review formatting before relying on automation: destination path
- CONTEXT: provenance marker not found as exact wording, review formatting before relying on automation: COPY_BATCH_001 Report
