...
- Version: 0.4.0
- Run ID: 2026-05-20T08:51:10.851350+00:00
...
| `validation_reports` | `PASS` | `n/a` | `n/a` | markdown reports=2; names: COPY_BATCH_001_VALIDATION_REPORT.md, README.md |
...
- validation_report_names=COPY_BATCH_001_VALIDATION_REPORT.md, README.md
